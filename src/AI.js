    ...
    <div className='mb-[160px]'>
      <div className="main-content">
        <div className="content font-black">
          ...
          <p className='lg:w-[700px] text-center mb-8'>Welcome to the Grade 6 Robotics and Soft Skills Program at Nipix Technology! Our comprehensive curriculum is designed to introduce students to the exciting world of robotics while nurturing essential soft skills vital for personal and academic growth. </p>
        </div>
      </div>
